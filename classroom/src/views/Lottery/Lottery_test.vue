  ...
  <div class="lottery-page">
    <section class="lottery-wrap">
      ...
      <div class="wrap-content">
        <div class="bulletin">毅*** 刚刚抽中了 10元优惠券</div>
        <div class="lottery-outzone">
          <div class="lottery-inbox" :class="{ 'all-show': drawing }">
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_voucher_didi_10.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">滴滴10元代金券</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_iqiyi_month.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">爱奇艺会员月卡</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                ...
                <div class="prize-txt">1288金币</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_baiduyun_month@3x.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">百度网盘会员1月</div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_voucher_20@3x.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">20元通用优惠券</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_jd_card_100@3x.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">京东卡100元</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_kindle.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">第四代Kindle</div>
              </div>
            </div>
            <div class="item">
              <div class="i-box">
                <div class="img-zone">
                  <img src="../../common/images/lottery_xiaomi_boxr@3x.jpg" class="prize-img" />
                </div>
                <div class="prize-txt">小米小爱音箱</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="dialog icons-notenought-dialog" v-show="showCoinNotEnought">
      <div class="main">
        ...
        <div class="btns">
          ...
          <div class="btn to-do" @click.stop="jumpPage()">做任务</div>
        </div>
      </div>
    </div>
    <!-- 提示弹窗：获得奖品 -->
...
let prizeDrawCount = 24;
let countPrizeTime = 0;
...
export default {
  ...
  methods: {
    ...
    drawPrize() {
      ...
      drawCoinLottery().then((data) => {
        ...
        if (prizeKey === 'didi_10') {
          // 滴滴10元代金券
          prizeDrawCount += 9;
        } else if (prizeKey === 'iqiyi_month') {
          // 爱奇艺月卡
          prizeDrawCount += 10;
        } else if (prizeKey === 'coin_1288') {
          // 1288金币
          prizeDrawCount += 3;
        } else if (prizeKey === 'voucher_20') {
          // 20元优惠券
          prizeDrawCount += 4;
        } else if (prizeKey === 'xiaomi_box') {
          // 小米小爱音箱
          prizeDrawCount += 5;
        } else if (prizeKey === 'kindle') {
          // 第四代kindle
          prizeDrawCount += 6;
        } else if (prizeKey === 'jd_100') {
          // 京东100元购物卡
          prizeDrawCount += 7;
        } else if (prizeKey === 'baiduyun_month') {
          // 百度网盘一个月
          prizeDrawCount += 8;
        }
        this.drawPrizeEffect(0, () => {
          console.log('我就看看');
          this.prizeConfirm(data);
    ...
    jumpPage() {},
    // 跑马灯效果
    drawPrizeEffect(loopIndex, callback) {
      console.log('drawPrizeEffect: ', loopIndex);
      const highlightSeq = [0, 1, 2, 5, 8, 7, 6, 3];
      const boxDom = document.getElementsByClassName('i-box');
      if (loopIndex < prizeDrawCount) {
        for (let i = 0; i < boxDom.length; i++) {
          if (i === highlightSeq[loopIndex % highlightSeq.length]) {
            console.log('%', loopIndex % highlightSeq.length);
            console.log('highlightSeq[loopIndex % highlightSeq.length]', highlightSeq[loopIndex % highlightSeq.length]);
            boxDom[i].classList.add('active');
          } else {
            setTimeout(() => {
              boxDom[i].classList.remove('active');
            }, 50);
          }
        }
        setTimeout(() => {
          console.log('loopIndex < 20 ?', loopIndex < 20);
          loopIndex < 20 ? countPrizeTime = 50 : countPrizeTime += 100;
          console.log('countPrizeTime:', countPrizeTime);
          this.drawPrizeEffect(loopIndex + 1, callback);
        }, countPrizeTime);
      } else {
        setTimeout(() => {
          for (let i = 0; i < boxDom.length; i++) {
...
.lottery-page {
  ...
  margin auto
  padding 0 16px 45px
  // background:linear-gradient(180deg,rgba(255,138,99,1) 0%,rgba(202,29,31,1) 100%);
